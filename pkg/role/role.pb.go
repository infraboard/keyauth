...
var file_pkg_role_pb_role_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_role_pb_role_proto_goTypes = []interface{}{
	(*Role)(nil),              // 0: keyauth.role.Role
	(*Set)(nil),               // 1: keyauth.role.Set
	(*CreateRoleRequest)(nil), // 2: keyauth.role.CreateRoleRequest
}
var file_pkg_role_pb_role_proto_depIdxs = []int32{
	2, // 0: keyauth.role.Role.data:type_name -> keyauth.role.CreateRoleRequest
