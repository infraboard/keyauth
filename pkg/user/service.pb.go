...
var file_pkg_user_pb_service_proto_rawDesc = []byte{
	...
	0x62, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x9f, 0x04, 0x0a,
	...
	0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x42, 0x28,
...
var file_pkg_user_pb_service_proto_goTypes = []interface{}{
	...
	(*Set)(nil),                    // 7: keyauth.user.Set
	(*User)(nil),                   // 8: keyauth.user.User
	(*Password)(nil),               // 9: keyauth.user.Password
}
var file_pkg_user_pb_service_proto_depIdxs = []int32{
	...
	7, // 7: keyauth.user.UserService.QueryAccount:output_type -> keyauth.user.Set
	8, // 8: keyauth.user.UserService.CreateAccount:output_type -> keyauth.user.User
	8, // 9: keyauth.user.UserService.DescribeAccount:output_type -> keyauth.user.User
	8, // 10: keyauth.user.UserService.BlockAccount:output_type -> keyauth.user.User
	8, // 11: keyauth.user.UserService.DeleteAccount:output_type -> keyauth.user.User
	8, // 12: keyauth.user.UserService.UpdateAccountProfile:output_type -> keyauth.user.User
	9, // 13: keyauth.user.UserService.UpdateAccountPassword:output_type -> keyauth.user.Password
